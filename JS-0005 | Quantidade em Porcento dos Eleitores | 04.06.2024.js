...
total_de_votos_nulos = Number(prompt(`Quantos votos foram nulos?` ));
    ...
    if(total_de_eleitores != soma_total_dos_votos){
        alert(`A quantidade de votos não são semelhantes ao total de eleitores!`);
         ...
         porcentagem_dos_votos_do_primeiro_candidato.toFixed(2);
         porcentagem_dos_votos_do_segundo_candidato.toFixed(2);
         porcentagem_dos_votos_brancos.toFixed(2);
         porcentagem_de_votos_nulos.toFixed(2);
